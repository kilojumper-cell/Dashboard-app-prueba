...
data=[]
for fecha in fechas:
  for x in range(np.random.poisson(10)): #10 ventas promedio por día
    data.append({
        'Fecha':fecha,
...
#Generamos un pequeño reporte de nuestros dataframe
...
fig_regiones=px.pie(df_regiones,values='ventas_totales',names='region',title='Distribución de Ventas por Región',
                    color_discrete_sequence=px.colors.sequential.RdBu)
fig_regiones.show()

#4. Correlación entre variables
df_corr=df[['cantidad','precio_unitario','ventas_totales']].corr()
fig_heatmap=px.imshow(df_corr,text_auto=True,aspect="auto",title='Correlación entre variables numéricas',
                      color_continuous_scale='Viridis')
fig_heatmap.show()

#5. Distribución de ventas

fig_dist=px.histogram(df,x='ventas_totales',nbins=50,title='Distribución de ventas individuales')
fig_dist.update_layout(bargap=0.2)
fig_dist.update_traces(marker_color='#FF5733') # Añadir color a las barras
fig_dist.show()
...
#Gráfico completo en la parte superior
